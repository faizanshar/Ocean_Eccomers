...
import {styles} from './Styleelectronic'
...
export default class ElectronicsScreen extends Component {
  ...
  componentDidMount() {
    const url = 'https://api-oceanstore.herokuapp.com/api/categories/2';
    fetch(url)
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={()=>this.props.navigation.goBack()}>
          <Image style={styles.imgback} source={require('../assets/whiteback.png')}/>
          </TouchableOpacity>
          <Text style={styles.txtelectronic}>Electronic</Text>
